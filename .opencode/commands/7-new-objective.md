...
### If no argument:
1. Review existing objectives (`npx 7n objective list` output above)
...
```bash
npx 7n objective create -d "<full description>" -s "<5-10 word summary>"
```
